...
<section id="inner-page">
  <div class="container">
    ...
    <div class="about-us">
      <div class="row">
        <div class="col-md-4 col-sm-6">{!!Html::image('influx/images/about.png','alt text', array('class'=>'img-responsive'))!!} </div>
        <!--/.col-md-4-->
        ...
        <div class="row testimonials">
          <div class="col-sm-4">
            <blockquote>
              ...
              <span class="clients-name">- John Doe, Company</span> {!!Html::image('influx/images/testimonials/man1.jpg','alt text', array('class'=>'img-circle img-thumbnail'))!!} </blockquote>
          </div>
          <div class="col-sm-4">
            <blockquote>
              <p class="clients-words">Maecenas tincidunt venenatis tempus. Nulla tristique euismod urna at ullamcorper.</p>
              <span class="clients-name">- Jane Doe, Company</span> {!!Html::image('influx/images/testimonials/woman1.jpg','alt text', array('class'=>'img-circle img-thumbnail'))!!} </blockquote>
          </div>
          <div class="col-sm-4">
            <blockquote>
              <p  class="clients-words">Aliquam euismod nunc id eros sollicitudin interdum. Integer eget sem nec nulla dictum dictum.</p>
              <span class="clients-name">- Brian Smith, Company</span> {!!Html::image('influx/images/testimonials/man1.jpg','alt text', array('class'=>'img-circle img-thumbnail'))!!} </blockquote>
          </div>
        </div>
        <!--/.row--> 
      </div>
